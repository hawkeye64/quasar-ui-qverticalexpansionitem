...
export default {
  ...
  data () {
    return {
      title: 'QVerticalExpansionItem',
      tagline: 'Vertical Expansion tab panels for your Quasar App',
      ...
      locationUrl: 'https://github.com/hawkeye64/quasar-ui-qverticalexpansionitem',
