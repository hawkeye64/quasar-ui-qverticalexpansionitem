<template>
  <q-list class="menu">
    <q-item clickable to="/docs">
      ...
      <q-item-section>
        <q-item-label>QVerticalExpansionItem docs</q-item-label>
    ...
    <q-item clickable to="/demo">
      ...
      <q-item-section>
        <q-item-label>QVerticalExpansionItem demo</q-item-label>
    ...
    <q-item clickable to="/examples">
      ...
      <q-item-section>
        <q-item-label>QVerticalExpansionItem examples</q-item-label>
        <q-item-label caption>Examples of how to do it</q-item-label>
      </q-item-section>
    </q-item>
    <q-separator />
    <q-item clickable tag="a" target="_blank" href="https://github.com/hawkeye64/quasar-ui-qverticalexpansionitem">
      <q-item-section avatar>
        <q-icon name="home" />
      </q-item-section>
      <q-item-section>
        <q-item-label>QVerticalExpansionItem home</q-item-label>
        <q-item-label caption>qverticalexpansionitem</q-item-label>
      </q-item-section>
    </q-item>
